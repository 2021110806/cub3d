...
/*   Updated: 2024/01/11 20:45:00 by minjeon2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	{
		if (path[0] == 'E' && path[1] == 'A' && path[2] == ' ')
			return (EAST);
		if (path[0] == 'W' && path[1] == 'E' && path[2] == ' ')
			return (WEST);
		if (path[0] == 'N' && path[1] == 'O' && path[2] == ' ')
			return (NORTH);
		if (path[0] == 'S' && path[1] == 'O' && path[2] == ' ')
			return (SOUTH);
		if (path[0] == 'F' && path[1] == ' ')
			return (FLOOR);
		if (path[0] == 'C' && path[1] == ' ')
